...
from .models import Order, Customer, Product, Lease
...
class SellerForm(forms.ModelForm):
    class Meta:
        model=Product
        fields=["title","full_title","slug","category","image","marked_price", "selling_price", "description", "contact_number", "contact_email", "available_for_lease", "warranty", "return_policy", "view_count"]

class LeaseForm(forms.ModelForm):
    class Meta:
        model=Lease
        fields=["name", "email", "address", "phone_number", "secondary_number", "date", "current_designation", "monthly_salary", "address_of_residence", "landlord_name", "duration_lived_in_this_residence", "explanation", "required_lease_time"]

# Generated by Django 4.1.7 on 2023-05-25 18:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(max_length=200)),
                ('full_title', models.CharField(default='', max_length=200)),
                ('slug', models.SlugField(unique=True)),
                ...
                ('available_for_lease', models.CharField(blank=True, max_length=300, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('payment_method', models.CharField(choices=[('Cash On Delivery', 'Cash On Delivery'), ('UPI', 'UPI')], default='Cash On Delivery', max_length=20)),
